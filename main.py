...
def run_pipeline():
    ...
    # Базовый ориентир аврорального овала для ИИ
    shift_south = "Штиль. Мончегорск — на передовой сияний, Таллинн/СПб — зона ожидания, Екатеринбург (Уральский рубеж) — под защитой, Сочи — глубокий тыл."
    if bz < -5 or pressure > 4: shift_south = "Среднее смещение. Накрывает Мончегорск и Мурманскую область, дотягивается до Таллинна и СПб. Екатеринбург чувствует дыхание космоса."
    if bz < -8 or pressure > 7: shift_south = "Серьезный прорыв. Сияет над Таллинном и СПб. На Уральском рубеже (Екатеринбург) разгораются сполохи. В Сочи всё спокойно."
    if bz < -12 or pressure > 12: shift_south = "Экстремальный шторм века. Пробивает всё от Мончегорска до Таллинна и Екатеринбурга, сияние катится к Москве, даже в Сочи смотрят на небо."
